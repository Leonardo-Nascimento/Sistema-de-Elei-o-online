 ...
 * @author Leonardo
 */
public class lControleAcessoAddCand extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        lUsuario acesso = (lUsuario)sessaoExistente.getAttribute("sessao");
         ...
         if (acesso != null){                   
                ...
                request.getRequestDispatcher("/adicionarcandidato").forward(request, response);
                //System.out.println("Numero: "+c.getLnumero()+ " Nome: "+c.getLnome()+ " Quantidade de votos: "+c.getlqndVoto());
                    
            }else{
                request.setAttribute("msg","Você não tem acesso a add candidato");
